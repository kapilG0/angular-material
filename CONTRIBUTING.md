...
If you find a bug in the source code, you can help by [submitting an issue](#submitting-an-issue) to  [AnguHashBlog](https://github.com/AnguHashBlog/issues).
...
You can file new issues by selecting from our [new issue templates](https://github.com/AnguHashBlog/issues/new/choose) and filling out the issue template.
...
1. Search [GitHub](https://github.com/AnguHashBlog/pulls) for an open or closed PR that relates to your submission.
